        ...
        return(
            <View style={{
                ...
                { this.props.buttons.map((button,index) => {
                    var bgColorIndicator = this.state.selectedIndex == index ? this.props.indicatorColor: "#ffffff"
                    var textColor = this.state.selectedIndex == index ? this.props.selectedTextColor :  this.props.textColor
                    return(
                        <Pressable onPress={()=> this._onTabPress(index)}>
                            <View style={[styles.tabContainer,  {
                                ...
                                <View style={[styles.tabContainerIndicator,{
