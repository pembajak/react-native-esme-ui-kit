        ...
        return(
            <ScrollView 
                ...
                <ButtonGroup
                    ...
                    selectedButtonStyle={[styles.selectedButton,this.props.selectedButtonStyle]}
                    selectedTextStyle={[styles.selectedText,this.props.selectedTextStyle]}
                    textStyle={[styles.text,this.props.textStyle]}
                    buttonStyle={[styles.button,this.props.buttonStyle]}
                    innerBorderStyle={{
                        width:0
                    }}
                    buttonContainerStyle={[styles.buttonContainer,this.props.buttonContainerStyle]}
